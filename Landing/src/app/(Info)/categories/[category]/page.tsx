...
//             {
//               cat_data?.features?.map((feature, index) => (
//                 <li className="info-features-li" key={index}>
//                   {feature}
//                 </li>
//               ))
//             }
...
async function fetchCategoryData(catSlug: string): Promise<CategoryData | null> {
  const product = categories_JSON.find((value) => value.slug === catSlug);
  return product || null;
}
...
export default async function CategoryPage({
  ...
  const cat_data = await fetchCategoryData(String(category));
  ...
  return (
    <>
      <Head>
        <title>{cat_data.category_name} || Sewad Infotech</title>
        <meta name="description" content={cat_data.description} />
        <meta property="og:description" content={cat_data.description} />
        <meta property="og:title" content={`${cat_data.category_name} || Sewad Infotech`} />
        <meta property="og:image" content="" />
      ...
      <section className="info-page-section">
        ...
        <section className="info-page-features-seciton">
          <section className="info-page-featureas-setion-left">
            <h2 className="info-page-features-h2">Features</h2>
            <ul className="inf-features-ul">
              {cat_data.features.map((feature, index) => (
                <li className="info-features-li" key={index}>{feature}</li>
              ))}
            </ul>
          </section>
          <section className="info-page-featureas-setion-right">
        ...
        <section className="info-page-features-seciton">
          ...
          <section className="info-page-featureas-setion-left">
            <h2 className="info-page-features-h2">Description</h2>
            <div className="categories-description">
              <p className="categories-description-p">{cat_data.description}</p>
            </div>
          </section>
        </section>
        ...
        <section className="info-page-features-seciton">
          <section className="info-page-featureas-setion-left">
            <h2 className="info-page-features-h2">Price Range (Single Unit)</h2>
            <div className="info-page-price-range-div">
              <div className="-price-div">
                <p className="max-p-key">Minimum Price</p>
                <p className="max-p-value"><FaRupeeSign /> {cat_data.min_cost}</p>
