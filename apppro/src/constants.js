...
export const filterAttributes = [
  {
    name: "Price",
    attributes: [5000, 7000, 10000, 15000, 20000, 25000],
  },
  {
    name: "Brand",
    attributes: ["brand 1", "brand 2", "brand 3", "brand 4"],
  },
  {
    name: "NumberOfCameras",
    attributes: [3, 5, 8, 10, 15, 20],
  },
  {
    name: "CameraType",
    attributes: ["DOME", "BULLET"],
  },
  {
    name: "CameraQuality",
    attributes: ["HD", "IP"],
  ...
  {
    name: "IndoorOutdoor",
    attributes: ["INDOOR", "OUTDOOR"],
  },
];

export const CATEGORIES_ENUM = [
  {
    categoryTitle: "HD Camera Setup",
    categoryImage: "./Assets/Categores/Hd.png",
    startingPrice: 12000,
  },
  {
    categoryTitle: "WIFI Camera Setup",
    categoryImage: "./Assets/Categores/Hd.png",
    startingPrice: 12000,
  },
  {
    categoryTitle: "Night Vision Camera Setup",
    categoryImage: "./Assets/Categores/Hd.png",
    startingPrice: 12000,
  },
  {
    categoryTitle: "Bullet Camera Setup",
    categoryImage: "",
    startingPrice: 12000,
  },
  {
    categoryTitle: "Dome Camera Setup",
    categoryImage: "",
    startingPrice: 12000,
  },
  {
    categoryTitle: "Out-Door Setup",
    categoryImage: "",
    startingPrice: 12000,
  },
  {
    categoryTitle: "Thermal Camera Setup",
    categoryImage: "",
    startingPrice: 12000,
  },
];
